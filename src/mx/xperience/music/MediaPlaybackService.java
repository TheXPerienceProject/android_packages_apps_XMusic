...
public class MediaPlaybackService extends Service {
    ...
    public static final String PLAYSTATE_CHANGED = "mx.xperience.music.playstatechanged";
    public static final String META_CHANGED = "mx.xperience.music.metadatachanged";
    public static final String SHUFFLE_CHANGED = "mx.xperience.music.shuffle";
    public static final String REPEAT_CHANGED = "mx.xperience.music.repeat";
    public static final String QUEUE_CHANGED = "mx.xperience.music.queuechanged";
    private static final String ACTION_DELETE_MUSIC = "com.android.fileexplorer.action.DELETE_MUSIC";

    public static final String SERVICECMD = "mx.xperience.music.musicservicecommand";
    ...
    private static final String UPDATE_WIDGET_ACTION = "mx.xperience.music.updatewidget";
    ...
    private static final String CHANNEL_ONE_NAME = "mx.xperience.music";
     ...
     * "mx.xperience.music.metadatachanged"
     * "mx.xperience.music.queuechanged",
     * "mx.xperience.music.playbackcomplete"
     * "mx.xperience.music.playstatechanged"
...
//            }
    ...
    private void updateNotification() {
        ...
        status1.setContentIntent(PendingIntent.getActivity(this, 0, new Intent(
                "mx.xperience.music.PLAYBACK_VIEWER")
